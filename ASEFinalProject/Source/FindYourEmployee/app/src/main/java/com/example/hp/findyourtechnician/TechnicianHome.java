...
public class TechnicianHome extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UserName = (TextView) findViewById(R.id.Technician_Profile_Registration_UserName);
        UserName.setText(Name);

        First = (EditText) findViewById(R.id.Technician_Profile_Registration_FirstName_TextField);
        Last = (EditText) findViewById(R.id.Technician_Profile_Registration_LastName_TextField);
        Email = (EditText) findViewById(R.id.Technician_Profile_Registration_EmailId_TextField);
        Phone = (EditText) findViewById(R.id.Technician_Profile_Registration_Contact_TextField);
        ...
        final Firebase GetProfileRef = new Firebase("https://findyourtechnician.firebaseio.com/Technicians");
    ...
    public void UpdateProfile(View view){
        ...
        final Firebase EditProfileRef = new Firebase("https://findyourtechnician.firebaseio.com/Technicians");

        final String FirstName = ((EditText)findViewById(R.id.Technician_Profile_Registration_FirstName_TextField)).getText().toString();
        final String LastName = ((EditText)findViewById(R.id.Technician_Profile_Registration_LastName_TextField)).getText().toString();
        final String EmaiId = ((EditText)findViewById(R.id.Technician_Profile_Registration_EmailId_TextField)).getText().toString();
        final String Contact = ((EditText)findViewById(R.id.Technician_Profile_Registration_Contact_TextField)).getText().toString();
        ...
        EditProfileRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.hasChild(Name)) {
                    ...
                    //Intent intent = new Intent(TechnicianHome.this, Home.class);
                    //startActivity(intent);
                }
            }
    ...
    public void ChangePassword(View view){
        Intent intent = new Intent(TechnicianHome.this,TechnicianPasswordChange.class);
